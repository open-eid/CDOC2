...
The interfaces are formally described in the [OpenAPI format](https://spec.openapis.org/oas/latest.html) (see [API References](../05_api_references/capsule_server_api.md)).
